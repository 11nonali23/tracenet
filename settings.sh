...
CALIPER_KGVERIFICATION_CONFIG=$CALIPER_DIR/benchmarks/shareAnonymizedKGForVerification.yaml
CALIPER_CALIPERPROOF_CONFIG=$CALIPER_DIR/benchmarks/verifyProof.yaml
CALIPER_KGRECIPIENT_CONFIG=$CALIPER_DIR/benchmarks/ShareAnonymizedKGWithRecipient.yaml
